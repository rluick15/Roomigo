        ...
        if(id == R.id.action_delete) {
            ...
            new MaterialDialog.Builder(this)
                    ...
                    .input(null, null, (dialog, input) -> {
                        ...
                        Bundle b = new Bundle();
                        b.putString(IntentFactory.SHARE_TEXT, reportText);
                        b.putString(IntentFactory.SHARE_SUBJECT, "Report User: " + recipientId);
                        b.putString(IntentFactory.SHARE_EMAIL, Constants.ROOMIGO_EMAIL);
                        IntentFactory.pickIntent(MessagingActivity.this, IntentFactory.SHARE, b);
                    })
                    .show();
        }
